...
public class OidnJna {
    public static final int OIDN_DEVICE_TYPE_DEFAULT = 0;
    public static final int OIDN_DEVICE_TYPE_CPU = 1;

    public static final int OIDN_FORMAT_FLOAT = 1;
    public static final int OIDN_FORMAT_FLOAT3 = 3;
